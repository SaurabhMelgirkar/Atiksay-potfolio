...
const roles = ["Python Developer", "Data Science Enthusiast", "AI/ML Engineer", "IoT Innovator"];
export const Hero = () => {
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="mb-8 animate-fade-in">
            <div className="w-40 h-40 mx-auto rounded-full bg-gradient-to-r from-primary to-accent p-1 shadow-2xl shadow-primary/20">
              <img src={profilePic} alt="Atishay Jayfale" className="w-full h-full rounded-full object-fill" />
            </div>
          </div>

          <p className="text-primary font-medium mb-4 animate-fade-in" style={{
          animationDelay: "0.1s"
        }}>
            Hello, I'm
          </p>

          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-4 animate-fade-in" style={{
          animationDelay: "0.2s"
        }}>
            Atishay <span className="gradient-text">Jayfale</span>
          </h1>

          <div className="h-12 mb-6 animate-fade-in" style={{
          animationDelay: "0.3s"
        }}>
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto mb-8 animate-fade-in" style={{
          animationDelay: "0.4s"
        }}>
          ...
          {/* Stats */}
          <div className="flex justify-center gap-8 md:gap-16 mb-10 animate-fade-in" style={{
          animationDelay: "0.5s"
        }}>
            {[{
            value: "5+",
